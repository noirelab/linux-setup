...
hl.bind(mainMod .. " + G",          hl.dsp.exec_cmd("xdg-open https://gemini.google.com"))
hl.bind(mainMod .. " + slash",      hl.dsp.exec_cmd(launchPrefix .. "discord"))
hl.bind(mainMod .. " + backslash",  hl.dsp.exec_cmd("curl -fsS --max-time 1 --unix-socket /run/user/1000/chico-trigger.sock -X POST http://localhost/trigger"))
...
-- Special workspace (scratchpad / minimize)
...
hl.bind(mainMod .. " + SHIFT + N",      hl.dsp.window.move({ workspace = "e+0" }))
