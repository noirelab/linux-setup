...
hl.workspace_rule({ workspace = "1", monitor = MONITOR2, default = true, persistent = true })
hl.workspace_rule({ workspace = "2", monitor = MONITOR2, default = true, persistent = true })
hl.workspace_rule({ workspace = "3", monitor = MONITOR2, default = true, persistent = true })
