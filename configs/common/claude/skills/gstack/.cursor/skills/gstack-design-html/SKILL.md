...
_ROOT=$(git rev-parse --show-toplevel 2>/dev/null)
D=""
[ -n "$_ROOT" ] && [ -x "$_ROOT/.cursor/skills/gstack/design/dist/design" ] && D="$_ROOT/.cursor/skills/gstack/design/dist/design"
...
_PRETEXT_VENDOR=""
_ROOT=$(git rev-parse --show-toplevel 2>/dev/null)
[ -n "$_ROOT" ] && [ -f "$_ROOT/.cursor/skills/gstack/design-html/vendor/pretext.js" ] && _PRETEXT_VENDOR="$_ROOT/.cursor/skills/gstack/design-html/vendor/pretext.js"
[ -z "$_PRETEXT_VENDOR" ] && [ -f ~/.cursor/skills/gstack/design-html/vendor/pretext.js ] && _PRETEXT_VENDOR=~/.cursor/skills/gstack/design-html/vendor/pretext.js
