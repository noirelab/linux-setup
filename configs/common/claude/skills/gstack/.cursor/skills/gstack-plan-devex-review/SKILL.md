...
Load the "## Pass 1" section from `~/.cursor/skills/gstack/plan-devex-review/dx-hall-of-fame.md`
...
~/.cursor/skills/gstack/bin/gstack-review-read 2>/dev/null | grep plan-devex-review || echo "NO_PRIOR_DX_REVIEWS"
```
...
Load reference: Read the "## Pass 3" section from `~/.cursor/skills/gstack/plan-devex-review/dx-hall-of-fame.md`.
...
`~/.cursor/skills/gstack/plan-devex-review/dx-hall-of-fame.md`.
...
```bash
~/.cursor/skills/gstack/bin/gstack-review-log '{"skill":"plan-devex-review","timestamp":"TIMESTAMP","status":"STATUS","initial_score":N,"overall_score":N,"product_type":"PRODUCT_TYPE","tthw_current":"TTHW_CURRENT","tthw_target":"TTHW_TARGET","mode":"MODE","persona":"PERSONA","competitive_tier":"COMPETITIVE_TIER","unresolved":N,"commit":"COMMIT"}'
```
