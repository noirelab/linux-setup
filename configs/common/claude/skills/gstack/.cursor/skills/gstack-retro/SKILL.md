...
```bash
DISCOVER_BIN=""
[ -x ~/.cursor/skills/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=~/.cursor/skills/gstack/bin/gstack-global-discover
[ -z "$DISCOVER_BIN" ] && [ -x .cursor/skills/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=.cursor/skills/gstack/bin/gstack-global-discover
