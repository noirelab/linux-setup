...
```bash
DISCOVER_BIN=""
[ -x ~/.gbrain/skills/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=~/.gbrain/skills/gstack/bin/gstack-global-discover
[ -z "$DISCOVER_BIN" ] && [ -x .gbrain/skills/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=.gbrain/skills/gstack/bin/gstack-global-discover
