...
```bash
DISCOVER_BIN=""
[ -x ~/.kiro/skills/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=~/.kiro/skills/gstack/bin/gstack-global-discover
[ -z "$DISCOVER_BIN" ] && [ -x .kiro/skills/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=.kiro/skills/gstack/bin/gstack-global-discover
