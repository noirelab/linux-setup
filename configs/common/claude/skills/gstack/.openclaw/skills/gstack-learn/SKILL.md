...
~/.openclaw/skills/gstack/bin/gstack-learnings-search --limit 20 2>/dev/null || echo "No learnings yet."
```
...
```bash
eval "$(~/.openclaw/skills/gstack/bin/gstack-slug 2>/dev/null)"
~/.openclaw/skills/gstack/bin/gstack-learnings-search --query "USER_QUERY" --limit 20 2>/dev/null || echo "No matches."
```
...
```bash
eval "$(~/.openclaw/skills/gstack/bin/gstack-slug 2>/dev/null)"
~/.openclaw/skills/gstack/bin/gstack-learnings-search --limit 100 2>/dev/null
```
...
```bash
eval "$(~/.openclaw/skills/gstack/bin/gstack-slug 2>/dev/null)"
~/.openclaw/skills/gstack/bin/gstack-learnings-search --limit 50 2>/dev/null
```
...
```bash
~/.openclaw/skills/gstack/bin/gstack-learnings-log '{"skill":"learn","type":"TYPE","key":"KEY","insight":"INSIGHT","confidence":N,"source":"user-stated","files":["FILE1"]}'
```
