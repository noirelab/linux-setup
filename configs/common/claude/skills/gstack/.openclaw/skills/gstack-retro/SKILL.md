...
```bash
DISCOVER_BIN=""
[ -x ~/.openclaw/skills/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=~/.openclaw/skills/gstack/bin/gstack-global-discover
[ -z "$DISCOVER_BIN" ] && [ -x .openclaw/skills/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=.openclaw/skills/gstack/bin/gstack-global-discover
