...
```bash
DISCOVER_BIN=""
[ -x ~/.slate/skills/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=~/.slate/skills/gstack/bin/gstack-global-discover
[ -z "$DISCOVER_BIN" ] && [ -x .slate/skills/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=.slate/skills/gstack/bin/gstack-global-discover
