...
```
/home/noirelab/.config/opencode/skills/seo/bin/claude-seo run dataforseo_costs.py check <endpoint> [--count N]
```
...
```
/home/noirelab/.config/opencode/skills/seo/bin/claude-seo run dataforseo_costs.py log <endpoint> <actual_cost>
```
