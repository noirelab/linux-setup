...
**Execution:**
```bash
/home/noirelab/.config/opencode/skills/seo/bin/claude-seo run drift_baseline.py <url>
/home/noirelab/.config/opencode/skills/seo/bin/claude-seo run drift_baseline.py <url> --skip-cwv
```
...
**Execution:**
```bash
/home/noirelab/.config/opencode/skills/seo/bin/claude-seo run drift_compare.py <url>
/home/noirelab/.config/opencode/skills/seo/bin/claude-seo run drift_compare.py <url> --baseline-id 5
/home/noirelab/.config/opencode/skills/seo/bin/claude-seo run drift_compare.py <url> --skip-cwv
```
...
```bash
/home/noirelab/.config/opencode/skills/seo/bin/claude-seo run drift_report.py <comparison_json_file> --output drift-report.html
```
...
**Execution:**
```bash
/home/noirelab/.config/opencode/skills/seo/bin/claude-seo run drift_history.py <url>
/home/noirelab/.config/opencode/skills/seo/bin/claude-seo run drift_history.py <url> --limit 10
```
