...
```
1. /home/noirelab/.config/opencode/skills/seo/bin/claude-seo run render_page.py <url> --mode auto → raw/rendered HTML
2. /home/noirelab/.config/opencode/skills/seo/bin/claude-seo run parse_html.py --url <url>   → SEO elements
...
```bash
/home/noirelab/.config/opencode/skills/seo/bin/claude-seo run dataforseo_costs.py check merchant_google_products_search
```
...
After each call:
```bash
/home/noirelab/.config/opencode/skills/seo/bin/claude-seo run dataforseo_costs.py log merchant_google_products_search <cost>
```
...
/home/noirelab/.config/opencode/skills/seo/bin/claude-seo run dataforseo_merchant.py search "<keyword>" --marketplace google

# Seller analysis: merchant ratings and dominance
/home/noirelab/.config/opencode/skills/seo/bin/claude-seo run dataforseo_merchant.py sellers "<keyword>"

# Normalize results for analysis
/home/noirelab/.config/opencode/skills/seo/bin/claude-seo run dataforseo_normalize.py results.json --module merchant
```
...
```bash
/home/noirelab/.config/opencode/skills/seo/bin/claude-seo run dataforseo_costs.py check merchant_amazon_products_search
```
...
/home/noirelab/.config/opencode/skills/seo/bin/claude-seo run dataforseo_merchant.py search "<keyword>" --marketplace amazon

# Cross-marketplace comparison
/home/noirelab/.config/opencode/skills/seo/bin/claude-seo run dataforseo_merchant.py compare "<keyword>"
```
...
/home/noirelab/.config/opencode/skills/seo/bin/claude-seo run ucp_check.py https://store.example.com --json

# With endpoint reachability probes (HEAD each declared capability)
/home/noirelab/.config/opencode/skills/seo/bin/claude-seo run ucp_check.py https://store.example.com --probe-endpoints --json
```
